package com.android.Safher.config;

import android.content.Context;
import android.content.SharedPreferences;

import com.android.Safher.BuildConfig;

@SuppressWarnings("unused")
public class Prefs {

    public static SharedPreferences prefs = com.android.safher.Safher.getAppContext().getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
